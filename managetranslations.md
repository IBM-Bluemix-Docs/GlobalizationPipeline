...
Once you have created bundles and started generating translations for your application, you can choose from machine translation and human translation. The machine generated content can be used as is or further modified. You can also choose to use a machine translation other than the default. This section covers instructions for the following tasks:
<ul>
<li>How to change the machine translation engine that performs the translations for your bundles?</li>
<li>How to perform human post-translation editing?</li>
<li>How to create human translation request?</li>
...
|--------|--------------------|--------------------|
| Draft  | No | The translation request is created but not submitted yet. You can still modify the content of the translation request or delete the translation request. |
...
| Merged | Yes | The human post editing result is merged back. The translation request is finished. You can generate a report at this point. You can keep the translation request for future reference, or delete it to save storage. The deletion of the translation request will not affect the merged translation result. |

To view the translation request detail, click the **View the request detail** icon ![Select the view request detail icon to view the translations of target language](images/viewProjectDetailIcon.png) from the **Actions** column.

![View translation request details](images/viewtr.png)

To generate a *JSON (.json)* report or XLIFF for your request, click the **Download Report** or the **Download XLIFF** button.
