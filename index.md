...
There two translation plans available on {{site.data.keyword.GlobalizationPipeline_short}}, the standard plan and the professional plan. Both the two plans provide integrated unlimited basic machine translation for nine languages. In a professional plan, {{site.data.keyword.GlobalizationPipeline_short}} offers professional translation review and editing service. You can switch from different {{site.data.keyword.GlobalizationPipeline_short}} plans within Bluemix with all data reserved. 

**Note:** When you are in a standard plan, you can still find your human post editing translation requests, but you are not able to create new translation requests under such circumstances.
